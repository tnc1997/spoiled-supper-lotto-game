...
void main() {
  group(
    'Plate',
    () {
      test('starts with every slot empty', () {
        final plate = Plate();
      ...
      test('can be constructed with cards already in some slots', () {
        const main = Card(
          id: '1',
      ...
      test('placing a card overwrites any card already in that slot', () {
        const first = Card(
          id: '1',
          type: CardType.standard,
      ...
      test('is not full until every slot has a card', () {
        final plate = Plate();
