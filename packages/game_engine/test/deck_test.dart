...
void main() {
  group(
    'buildDeck',
    () {
      test('builds 30 cards in total', () {
        final deck = buildDeck();

        expect(deck, hasLength(30));
      });

      test('builds 20 standard cards and 10 Spoiled cards', () {
        final deck = buildDeck();
      ...
      test('builds 4 standard cards and 2 Spoiled cards per category', () {
        final deck = buildDeck();
      ...
      test('builds every card with a unique id', () {
        final deck = buildDeck();
      ...
      test('includes the confirmed Spoiled card names', () {
        final deck = buildDeck();
        final names = deck
      ...
      test('builds a fresh deck on every call', () {
